  ...
  return (
    <div className="my-20">
      ...
      <ul>
        ...
        <li>
          • <strong>Application</strong> refers to Clinitime, the software
          program provided by the Company.
        </li>
        <li>
          • <strong>Company</strong> refers to Clinitime.
        </li>
        <li>
      ...
      <h3>Contact Us</h3>
      <ul>
        <li>• By email: rajscape@gmail.com</li>
        <li>
          • By visiting:{" "}
          <a href="https://rajscape.com/contact">rajscape.com/contact</a>
        </li>
        <li>• By phone: (224) 558-8478</li>
      </ul>
    </div>
  );
};
